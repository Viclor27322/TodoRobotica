      ...
      <section className="sect1_footer_inf text-white">
            ...
            <div id="footer_inf2" >
                ...
                <div className="sect2_footer">
                    <a href="https://wa.me/547711913179"><i className="fa-brands"></i></a>                
        ...
        <section className="sect3_footer">
            <a  target="blank"  href="https://instagram.com/todorobotica.01?igshid=YmMyMTA2M2Y=">
            <img src={insta} width="30" height="30"/></a>
            <a  target="blank"  href="https://www.facebook.com/Todo-Robotica-100956559345957/?ti=as">
            <img src={face}  width="30" height="30"/></a>
            <a  target="blank" href="https://wa.me/qr/LVPFTGPJNXXNO1">
